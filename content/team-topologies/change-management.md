...
* Use [Facilitation](../facilitation) methods to run key meetings and workshops, for scale and efficiency.
...
* Communications: Tailor to the different stakeholders types. Business wants/needs other type of messaging, than the POs, than the actual team members. each also has other communication frequency needs. Make a communication plan to set who, when, how, and what gets communicated to.
